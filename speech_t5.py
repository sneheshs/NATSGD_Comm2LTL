...
modality = 'speech'
model_ver = 'T5'
train_scores_file = os.getcwd() + '/results/scores/speechT5/train/train_score_' + modality +'-'+ model_ver + '.txt'
test_scores_file = os.getcwd() + '/results/scores/speechT5/test/test_score_' + modality +'-'+ model_ver + '.txt'
...
train_data_directory = os.getcwd() + '/results/predictions/speechT5/train/'
test_data_directory = os.getcwd() + '/results/predictions/speechT5/test/'
...
model_file = os.getcwd() + '/results/speech_T5.pth'
