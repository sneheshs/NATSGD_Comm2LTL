...
modality = 'gestures'
model_ver = 'bart'
train_scores_file =os.getcwd()+ '/data/results/scores/gesturesBart/train/train_score_' + modality +'-'+ model_ver + '.txt'
test_scores_file =os.getcwd()+ '/data/results/scores/gesturesBart/test/test_score_' + modality +'-'+ model_ver + '.txt'
...
train_data_directory =os.getcwd()+ '/data/results/predictions/gesturesBart/train/'
test_data_directory =os.getcwd()+ '/data/results/predictions/gesturesBart/test/'
...
model_file =os.getcwd()+ '/data/results/gestures_bart.pth'
