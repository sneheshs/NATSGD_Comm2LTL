...
#         ges = model_pos.get_representation(ges) # Yantian
...
model_ver = 'bart'
train_scores_file = os.getcwd + '/results/scores/speechGesturesBart/train/train_score_' + modality +'-'+ model_ver + '.txt'
test_scores_file = os.getcwd() + '/results/scores/speechGesturesBart/test/test_score_' + modality +'-'+ model_ver + '.txt'
...
train_data_directory = os.getcwd() + '/results/predictions/speechGesturesBart/train/'
test_data_directory = os.getcwd() + '/results/predictions/speechGesturesBart/test/'
...
model_file = os.getcwd() + '/results/speechGestures_bart.pth'
